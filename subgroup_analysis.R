...
require(plotrix)
par(mar=c(5,5,3,3))
plotCI(bmi, rate, ui=rate+1.28*se, li=rate-1.28*se, xlim=c(19, 45), ylim=c(-0.10, 0.10), xlab="BMI", ylab="Change in SAE incidence with treatment", main="BMI vs effect of treatment on SAE",axes=F, mgp=c(3,0,0))
